...
- **`iconifyApiSource` can target a self-hosted Iconify API.** Pass `host: "https://icons.example.com"` to resolve icons from [your own API instance](https://iconify.design/docs/api/hosting.html) instead of the public `api.iconify.design`.
