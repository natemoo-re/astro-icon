...
describe("renderableIconProps", () => {
  ...
  it("lets an explicit width/height override the entry's when size isn't set", () => {
    const { normalizedProps } = renderableIconProps(entry, { collection: "mdi", name: "home" }, { width: 40 });
