...
- `src/content.config.ts` - one added line: an `icons` collection from `localSvg()` with every default left alone: [**UC1**](../PERSONA.md#use-cases-ranked).
