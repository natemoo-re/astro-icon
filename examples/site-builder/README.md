...
- `src/content.config.ts` - one added line: an `icons` collection from `localIcons()` with every default left alone: [**UC1**](../PERSONA.md#use-cases-ranked).
