...
// @ts-nocheck - vendored from flowbite-astro-admin-dashboard, which never ran
// `astro check`: its chart-option builders assign into `let colors = {}` and
// rely on loose inference. Kept as-is to stay diffable against upstream.
