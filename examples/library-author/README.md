...
- `src/components/Header.astro` / `Footer.astro` - the starter's three hand-pasted social `<svg>`s, now `<Icon name="mastodon">` etc. against the site's own `icons` collection.
